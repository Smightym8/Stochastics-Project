...
def generate_boxplots(dataset: pd.DataFrame, plots_dir: str):
    ...
    bill_length_boxplot_ax.boxplot(dataset.bill_length_mm)
    ...
    bill_depth_boxplot_ax.boxplot(dataset.bill_depth_mm)
    ...
    flipper_length_boxplot_ax.boxplot(dataset.flipper_length_mm)
    ...
    body_mass_boxplot_ax.boxplot(dataset.body_mass_g)
    ...
    bill_length_male_boxplot_ax.boxplot(dataset_male.bill_length_mm)
    ...
    bill_length_female_boxplot_ax.boxplot(dataset_female.bill_length_mm)
    ...
    bill_depth_male_boxplot_ax.boxplot(dataset_male.bill_depth_mm)
    ...
    bill_depth_female_boxplot_ax.boxplot(dataset_female.bill_depth_mm)
    ...
    flipper_length_male_boxplot_ax.boxplot(dataset_male.flipper_length_mm)
    ...
    flipper_length_female_boxplot_ax.boxplot(dataset_female.flipper_length_mm)
    ...
    body_mass_male_boxplot_ax.boxplot(dataset_male.body_mass_g)
    ...
    body_mass_female_boxplot_ax.boxplot(dataset_female.body_mass_g)
